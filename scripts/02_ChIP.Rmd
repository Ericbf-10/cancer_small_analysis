...
- Sample 1: Murine Neuro2a (N2a) cells. These are a widely used mouse neuroblastoma cell line derived from the spontaneous tumor of a strain A albino mouse.

- Sample 2: Replicate of sample 1.

- Sample 3: Murine Embryonic Stem cells. These are transgenic A2lox ES cells harboring the murine Phf21b fused to an N-terminal HA tag under the control of a doxycycline-inducible promoter.
